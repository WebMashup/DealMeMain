...
public class MapFilterWidget extends Composite {

    private static FilterWidgetUiBinder uiBinder = GWT
            .create(FilterWidgetUiBinder.class);

    interface FilterWidgetUiBinder extends UiBinder<Widget, MapFilterWidget> {
    }
    ...
    public @UiConstructor MapFilterWidget(final DealServiceAsync dealService,
